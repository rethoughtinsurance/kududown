...
struct KuduScan {
    ...
    KuduScan() :
        ...
        predicateList(std::vector<KuduPredicate >())
        { }
};

inline
KuduColumnEncoding _KuduScan_avsc_Union__0__::get_KuduColumnEncoding() const {
    if (idx_ != 1) {
...
inline
void _KuduScan_avsc_Union__0__::set_KuduColumnEncoding(const KuduColumnEncoding& v) {
    idx_ = 1;
    value_ = v;
}

inline
KuduComparisonPredicate _KuduScan_avsc_Union__1__::get_KuduComparisonPredicate() const {
    if (idx_ != 1) {
        throw avro::Exception("Invalid type for union");
    }
...
inline
void _KuduScan_avsc_Union__1__::set_KuduComparisonPredicate(const KuduComparisonPredicate& v) {
    idx_ = 1;
    value_ = v;
}

inline
KuduInListPredicate _KuduScan_avsc_Union__1__::get_KuduInListPredicate() const {
    if (idx_ != 2) {
        throw avro::Exception("Invalid type for union");
    }
...
inline
void _KuduScan_avsc_Union__1__::set_KuduInListPredicate(const KuduInListPredicate& v) {
    idx_ = 2;
    value_ = v;
}

inline _KuduScan_avsc_Union__0__::_KuduScan_avsc_Union__0__() : idx_(0) { }
inline _KuduScan_avsc_Union__1__::_KuduScan_avsc_Union__1__() : idx_(0) { }
}
namespace avro {
