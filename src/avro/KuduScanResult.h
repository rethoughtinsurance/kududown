...
#ifndef AVRO_KUDUSCANRESULT_H_321375268__H_
#define AVRO_KUDUSCANRESULT_H_321375268__H_
...
struct _KuduScanResult_avsc_Union__0__ {
private:
    size_t idx_;
    boost::any value_;
public:
    ...
    _KuduScanResult_avsc_Union__0__();
};

struct KuduDataValue {
    typedef _KuduScanResult_avsc_Union__0__ value_t;
...
struct KuduScanResult {
    std::string scanId;
    std::vector<KuduRow > rows;
    KuduScanResult() :
        scanId(std::string()),
        rows(std::vector<KuduRow >())
        { }
};

inline
std::string _KuduScanResult_avsc_Union__0__::get_string() const {
    if (idx_ != 1) {
...
inline
void _KuduScanResult_avsc_Union__0__::set_string(const std::string& v) {
    idx_ = 1;
    value_ = v;
}

inline
std::vector<uint8_t> _KuduScanResult_avsc_Union__0__::get_bytes() const {
    if (idx_ != 2) {
        throw avro::Exception("Invalid type for union");
    }
...
inline
void _KuduScanResult_avsc_Union__0__::set_bytes(const std::vector<uint8_t>& v) {
    idx_ = 2;
    value_ = v;
}

inline _KuduScanResult_avsc_Union__0__::_KuduScanResult_avsc_Union__0__() : idx_(0) { }
}
namespace avro {
...
template<> struct codec_traits<rtip::_KuduScanResult_avsc_Union__0__> {
    static void encode(Encoder& e, rtip::_KuduScanResult_avsc_Union__0__ v) {
    ...
    static void decode(Decoder& d, rtip::_KuduScanResult_avsc_Union__0__& v) {
...
template<> struct codec_traits<rtip::KuduScanResult> {
    static void encode(Encoder& e, const rtip::KuduScanResult& v) {
        avro::encode(e, v.scanId);
        avro::encode(e, v.rows);
    }
    static void decode(Decoder& d, rtip::KuduScanResult& v) {
        if (avro::ResolvingDecoder *rd =
            dynamic_cast<avro::ResolvingDecoder *>(&d)) {
            const std::vector<size_t> fo = rd->fieldOrder();
            for (std::vector<size_t>::const_iterator it = fo.begin();
                ...
                switch (*it) {
                case 0:
                    avro::decode(d, v.scanId);
                    break;
                case 1:
                    avro::decode(d, v.rows);
                    break;
                default:
                    break;
                }
