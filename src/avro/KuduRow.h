...
#ifndef AVRO_KUDUROW_H_321375268__H_
#define AVRO_KUDUROW_H_321375268__H_
...
struct _KuduRow_avsc_Union__0__ {
private:
    size_t idx_;
    boost::any value_;
public:
    ...
    _KuduRow_avsc_Union__0__();
};

struct KuduDataValue {
    typedef _KuduRow_avsc_Union__0__ value_t;
...
inline
std::string _KuduRow_avsc_Union__0__::get_string() const {
    if (idx_ != 1) {
...
inline
void _KuduRow_avsc_Union__0__::set_string(const std::string& v) {
    idx_ = 1;
    value_ = v;
}

inline
std::vector<uint8_t> _KuduRow_avsc_Union__0__::get_bytes() const {
    if (idx_ != 2) {
        throw avro::Exception("Invalid type for union");
    }
...
inline
void _KuduRow_avsc_Union__0__::set_bytes(const std::vector<uint8_t>& v) {
    idx_ = 2;
    value_ = v;
}

inline _KuduRow_avsc_Union__0__::_KuduRow_avsc_Union__0__() : idx_(0) { }
}
namespace avro {
...
template<> struct codec_traits<rtip::_KuduRow_avsc_Union__0__> {
    static void encode(Encoder& e, rtip::_KuduRow_avsc_Union__0__ v) {
    ...
    static void decode(Decoder& d, rtip::_KuduRow_avsc_Union__0__& v) {
